...
public enum DebateStance: String, Codable, CaseIterable {
    case `for` = "for"
...
public struct DebateArgument: Codable, Identifiable {
    let id: String
...
public struct DebateTopic: Codable, Identifiable {
    let id: String
...
public struct DebateAlert: Codable, Identifiable {
...
public struct DebateInsight: Codable, Identifiable {
