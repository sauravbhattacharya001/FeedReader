...
class ArticleDigestComposer {
    ...
    private func exportHTML(_ digest: ArticleDigest) -> String {
        ...
        <title>\(Self.escapeHTML(digest.title))</title>
        <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        <div class="container">
        <div class="header">
        <h1>\(Self.escapeHTML(digest.title))</h1>
        <div class="subtitle">\(Self.escapeHTML(digest.subtitle))</div>
        </div>
        <div class="stats">
        ...
        <div class="greeting">\(Self.escapeHTML(digest.greeting))</div>
        """
        
        for section in digest.sections {
            html += """
            <div class="section">
            <div class="section-title">\(section.emoji) \(Self.escapeHTML(section.title))</div>
            """
            
            if let note = section.note {
                html += "<div class=\"section-note\">\(Self.escapeHTML(note))</div>"
            }
            ...
            for item in section.items {
                ...
                html += """
                <div class="article">
                <div class="article-title"><a href="\(Self.escapeHTML(item.url))">\(Self.escapeHTML(item.title))</a>\(starBadge)</div>
                <div class="article-meta">\(Self.escapeHTML(metaParts))</div>
                """
                
                if !item.snippet.isEmpty {
                    html += "<div class=\"article-snippet\">\(Self.escapeHTML(item.snippet))</div>"
                }
        ...
        html += """
        <div class="footer">
        <p>\(Self.escapeHTML(digest.signoff))</p>
